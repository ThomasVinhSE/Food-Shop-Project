 ...
 * @author Vinh
 */
@WebServlet(name = "RestoreProductServlet", urlPatterns = {"/RestoreProductServlet"})
        ...
        try
        {
            ...
            if (session != null) {
                ...
                if (result) {
                    ...
                    String message = "Cập nhật lại status để bán hàng (productId = " + productId + ")";
            ...
            log("NumberFormat_Delete: "+ex.getMessage());
        }
        catch (NamingException ex) {
            log("Naming_Delete: "+ex.getMessage());
        } catch (SQLException ex) {
            log("SQL_Delete: "+ex.getMessage());
            request.setAttribute("MESSAGE", "Không thể khôi phục product ngay bây giờ, thử lại sau");
        }        finally{
